...
namespace VMISP {
    ...
    public partial class WebProfile {
        ...
        public virtual string solname {
            get {
                return ((string)(this.GetPropertyValue("solname")));
            }
            set {
                this.SetPropertyValue("solname", value);
            }
        }
        
        public virtual string sol {
            get {
                return ((string)(this.GetPropertyValue("sol")));
            }
            set {
                this.SetPropertyValue("sol", value);
            }
        }
        
        public virtual string pocategory {
            get {
                return ((string)(this.GetPropertyValue("pocategory")));
            }
            set {
                this.SetPropertyValue("pocategory", value);
            }
        }
        
        public virtual string changepwd {
            get {
                return ((string)(this.GetPropertyValue("changepwd")));
            }
            set {
                this.SetPropertyValue("changepwd", value);
            }
        }
        
        public virtual string nameofuser {
            get {
                return ((string)(this.GetPropertyValue("nameofuser")));
            }
            set {
                this.SetPropertyValue("nameofuser", value);
            }
        }
        
        public virtual string deptlist {
            get {
                return ((string)(this.GetPropertyValue("deptlist")));
            }
            set {
                this.SetPropertyValue("deptlist", value);
            }
        }
