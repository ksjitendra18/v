...
namespace VMISP.Master
{
    public partial class frmRegister : System.Web.UI.Page
    {
        ...
        int intID = 0;
        string strREGCODE = string.Empty;
        ...
        public void funcSave(string p_strMode)
        {
            ...
            try
            {
                ...
                cmdSave.CommandText = "[dbo].[spRegister_Update]";
                ...
                cmdSave.Parameters.AddWithValue("@p_CODE", strREGCODE);
        ...
        public void funcShow(string p_strNo, string strTable, string strView)
        {
            ...
            try
            {
                ...
                cmdView.CommandText = "[dbo].[spRegister_View]";
        ...
        protected void gvMain_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName.ToUpper() == "VIEW")
                {
                    ...
                    strREGCODE = strValue[0];
                    strTABLE = strValue[1];

                    if (strREGCODE != "0")
                    {
                        funcShow(strREGCODE, strTABLE, "GET");
                    }
                }
            }
            catch (Exception eg)
