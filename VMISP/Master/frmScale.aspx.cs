...
{
    public partial class frmScale : System.Web.UI.Page
    {
        ...
        string strSCALECODE = string.Empty;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            #region ** JS Function  **
            imgGet.Attributes.Add("onclick", "return funcSearch_Validation('" + txtScaleCode.ClientID + "','" + "Enter Code...!" + "')");
            btnSubmit.Attributes.Add("onclick", "return funcScaleMaster_Validation('" + txtScaleCode.ClientID + "','" + txtScale.ClientID + "')");
            btnUpdate.Attributes.Add("onclick", "return funcScaleMaster_Validation('" + txtScaleCode.ClientID + "','" + txtScale.ClientID + "')");
            #endregion
        }
        ...
        public void funcSave(string p_strMode)
        {
            ...
            try
            {
                strSCALECODE = txtScaleCode.Text.Trim();
                strSCALE = txtScale.Text;
                ...
                cmdSave.CommandText = "[dbo].[spScale_Update]";
                ...
                cmdSave.Parameters.AddWithValue("@p_SCALECODE", strSCALECODE);
        ...
        public void funcShow(string p_strNo, string strView)
        {
            ...
            try
            {
                ...
                cmdView.CommandText = "[dbo].[spScale_View]";
        ...
        public void funcBindControl(DataTable dt)
        {
            ...
            txtScaleCode.Text = dtData.Rows[0]["CODE"].ToString();
            txtScale.Text = dtData.Rows[0]["SCALE"].ToString();
        ...
        {
            txtScaleCode.Text = string.Empty;
        ...
        {
            strSearchNo = txtScaleCode.Text.Trim();
        ...
        {
            strSearchNo = txtScaleCode_LIST.Text.Trim();
            if (strSearchNo == "")
            {
                strSearchNo = "LIST";
            }
        ...
        protected void gvMain_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                {
                    strSCALECODE = e.CommandArgument.ToString();

                    if (strSCALECODE != "")
                    {
                        funcShow(strSCALECODE, "GET");
                    }
                }
            }
            catch (Exception eg)
