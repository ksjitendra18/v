<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true"
    CodeBehind="frmScale.aspx.cs" Inherits="VMISP.Master.frmScale" %>
            ...
            <act:TabPanel ID="tabEntry" runat="server">
                <HeaderTemplate>
                    <asp:Label ID="lblEntryHeaderText" runat="server" Font-Bold="True" ForeColor="#FF3300"
                        Font-Size="Small" Text="Entry" ToolTip="Scale Master Entry"></asp:Label>
                </HeaderTemplate>
                <ContentTemplate>
                    <table width="60%">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtScaleCode" runat="server" Width="85px" CssClass="txtDefault"></asp:TextBox>
                                &nbsp;<asp:ImageButton ID="imgGet" runat="server" ImageAlign="Middle" ImageUrl="~/images/Search.jpg"
                                    Width="25px" Height="30px" OnClick="btnGet_Click" ToolTip="Scale Search" />
                            </td>
                        </tr>
                        <tr>
                            <tr>
                                <td class="tdTextReight">
                                    <asp:Label ID="lblScaleRequired" runat="server" Text="*" Font-Bold="True" ForeColor="Red"></asp:Label><span
                                        class="lblCaption">Scale Name :</span>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtScale" runat="server" Width="400px" CssClass="txtDefault"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="tdTextReight">
            ...
            <act:TabPanel ID="tabList" runat="server" HeaderText="List">
                <HeaderTemplate>
                    <asp:Label ID="lblListHeaderText" runat="server" Font-Bold="True" ForeColor="#FF3300"
                        Font-Size="Small" Text="List" ToolTip="List of Scale Master Entry"></asp:Label>
                </HeaderTemplate>
                <ContentTemplate>
                    <table width="50%">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtScaleCode_LIST" runat="server" Width="100px" CssClass="txtDefault"></asp:TextBox>
                                &nbsp;<asp:ImageButton ID="imgSearch_List" runat="server" ImageAlign="Middle" ImageUrl="~/images/Search.jpg"
                                    Width="25px" Height="30px" OnClick="imgSearch_LIST_Click" ToolTip="Scale Search" />
                                            ...
                                            <asp:TemplateField HeaderStyle-CssClass="gridText" ItemStyle-CssClass="gridText">
                                                ...
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="imgbtnView" runat="server" CausesValidation="false" CommandName="View"
                                                        ToolTip='<%# Eval("SCALE") %>' ImageUrl="~/images/selg_16.png" Height="20px"
                                                        Width="18px" CommandArgument='<%# Eval("CODE")%>' />
                                                </ItemTemplate>
                                                <ItemStyle Width="5%" />
                                            </asp:TemplateField>
