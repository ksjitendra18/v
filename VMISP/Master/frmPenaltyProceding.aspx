<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true"
    CodeBehind="frmPenaltyProceding.aspx.cs" Inherits="VMISP.Master.frmPenaltyProceding" %>
            ...
            <act:TabPanel ID="tabEntry" runat="server">
                <HeaderTemplate>
                    <asp:Label ID="lblEntryHeaderText" runat="server" Font-Bold="True" ForeColor="#FF3300"
                        Font-Size="Small" Text="Entry" ToolTip="Penalty Proceeding Master Entry"></asp:Label>
                </HeaderTemplate>
                <ContentTemplate>
                    <table width="60%">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                &nbsp;<asp:ImageButton ID="imgGet" runat="server" ImageAlign="Middle" ImageUrl="~/images/Search.jpg"
                                    Width="25px" Height="30px" OnClick="btnGet_Click" ToolTip="Penalty Proceeding Search" />
                            </td>
                        </tr>
                        <tr>
                            <tr>
            ...
            <act:TabPanel ID="tabList" runat="server" HeaderText="List">
                <HeaderTemplate>
                    <asp:Label ID="lblListHeaderText" runat="server" Font-Bold="True" ForeColor="#FF3300"
                        Font-Size="Small" Text="List" ToolTip="List of Penalty Proceeding Master Entry"></asp:Label>
                </HeaderTemplate>
                <ContentTemplate>
                    <table width="50%">
                        <tr>
                            ...
                            <td>
                                ...
                                &nbsp;<asp:ImageButton ID="imgSearch_List" runat="server" ImageAlign="Middle" ImageUrl="~/images/Search.jpg"
                                    Width="25px" Height="30px" OnClick="imgSearch_LIST_Click" ToolTip="Penalty Proceeding Search" />
                                            ...
                                            <asp:TemplateField HeaderStyle-CssClass="gridText" ItemStyle-CssClass="gridText">
                                                ...
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="imgbtnView" runat="server" CausesValidation="false" CommandName="View"
                                                        ...
                                                        CommandArgument='<%#Eval("CODE")+","+ Eval("FORTABLE")%>' />
                                                </ItemTemplate>
                                                <ItemStyle Width="5%" />
                                            </asp:TemplateField>
