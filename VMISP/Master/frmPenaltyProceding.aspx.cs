...
{
    public partial class frmPenaltyProceding : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                funcShow("LIST", null, "LIST"); //for bind grid view on form Load
            }
            ...
            #region ** JS Function  **
            imgGet.Attributes.Add("onclick", "return funcSearchMaster_Validation('" + ddlTable.ClientID + "','" + txtCode.ClientID + "','" + "Select Table Name...!" + "','" + "Enter Code of Register...!" + "')");
            btnSubmit.Attributes.Add("onclick", "return funcStatusMaster_Validation('" + txtCode.ClientID + "','" + ddlTable.ClientID + "','" + txtName.ClientID + "')");
            btnUpdate.Attributes.Add("onclick", "return funcStatusMaster_Validation('" + txtCode.ClientID + "','" + ddlTable.ClientID + "','" + txtName.ClientID + "')");
            #endregion
        }
        ...
        public void funcSave(string p_strMode)
        {
            ...
            try
            {
                ...
                intREGCODE = objCommonFunction.convertToInt(txtCode);
                ...
                cmdSave.CommandText = "[dbo].[spPenaltyProceding_Update]";
                ...
                cmdSave.Parameters.AddWithValue("@p_CODE", intREGCODE);
        ...
        public void funcShow(string p_strNo, string strTable, string strView)
        {
            ...
            try
            {
                ...
                cmdView.CommandText = "[dbo].[spPenaltyProceding_View]";
                ...
                cmdView.Parameters.AddWithValue("@p_TABLE", strTable);
        ...
        protected void imgSearch_LIST_Click(object sender, ImageClickEventArgs e)
        {
            ...
            funcShow(strSearchNo, null, "SEARCH");
        ...
        protected void gvMain_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName.ToUpper() == "VIEW")
                {
                    ...
                    intREGCODE = Convert.ToInt32(strValue[0]);
                    strTABLE = strValue[1];

                    if (intREGCODE != 0)
                    {
                        funcShow(intREGCODE.ToString(), strTABLE, "GET");
                    }
                }
            }
            catch (Exception eg)
