<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true"
    CodeBehind="frmSourceRef.aspx.cs" Inherits="VMISP.Master.frmSourceRef" %>
            ...
            <act:TabPanel ID="tabEntry" runat="server">
                <HeaderTemplate>
                    <asp:Label ID="lblEntryHeaderText" runat="server" Font-Bold="True" ForeColor="#FF3300"
                        Font-Size="Small" Text="Entry" ToolTip="Source Ref Master Entry"></asp:Label>
                </HeaderTemplate>
                <ContentTemplate>
                    <table width="60%">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                &nbsp;<asp:ImageButton ID="imgGet" runat="server" ImageAlign="Middle" ImageUrl="~/images/Search.jpg"
                                    Width="25px" Height="30px" OnClick="btnGet_Click" ToolTip="Source Ref Search" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdTextReight">
                                <asp:Label ID="lblSourceRefRequired" runat="server" Text="*" Font-Bold="True" ForeColor="Red"></asp:Label><span
                                    class="lblCaption">Source Ref :</span>
                            </td>
                            <td>
            ...
            <act:TabPanel ID="tabList" runat="server" HeaderText="List">
                <HeaderTemplate>
                    <asp:Label ID="lblListHeaderText" runat="server" Font-Bold="True" ForeColor="#FF3300"
                        Font-Size="Small" Text="List" ToolTip="List of Source Ref Entry"></asp:Label>
                </HeaderTemplate>
                <ContentTemplate>
                    <table width="50%">
                        <tr>
                            ...
                            <td>
                                ...
                                &nbsp;<asp:ImageButton ID="imgSearch_List" runat="server" ImageAlign="Middle" ImageUrl="~/images/Search.jpg"
                                    Width="25px" Height="30px" OnClick="imgSearch_LIST_Click" ToolTip="Source Ref Search" />
                                            ...
                                            <asp:TemplateField HeaderStyle-CssClass="gridText" ItemStyle-CssClass="gridText">
                                                ...
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="imgbtnView" runat="server" CausesValidation="false" CommandName="View"
                                                        ToolTip='<%# Eval("SOURCEREF") %>' ImageUrl="~/images/selg_16.png" Height="20px"
