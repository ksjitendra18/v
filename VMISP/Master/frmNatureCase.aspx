<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true"
    CodeBehind="frmNatureCase.aspx.cs" Inherits="VMISP.Master.frmNatureCase" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="act" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="../css/ssMain.css" rel="stylesheet" type="text/css" />
    <script src="../Js/jquery-1.8.0.min.js" type="text/javascript" lang="javascript"></script>
    <script src="../Js/JS_CommonFunction.js" type="text/javascript" lang="javascript"></script>
    <script src="../Js/JS_CommonValidation.js" type="text/javascript" lang="javascript"></script>
</asp:Content>
            ...
            <act:TabPanel ID="tabEntry" runat="server">
                <HeaderTemplate>
                    <asp:Label ID="lblEntryHeaderText" runat="server" Font-Bold="True" ForeColor="#FF3300"
                        Font-Size="Small" Text="Entry" ToolTip="Nature Case Master Entry"></asp:Label>
                </HeaderTemplate>
                <ContentTemplate>
                    <table width="60%">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNatureCode" runat="server" Width="85px" CssClass="txtDefault"></asp:TextBox>
                        ...
                        <tr>
                            <td class="tdTextReight">
                                <asp:Label ID="lblCaseNatureRequired" runat="server" Text="*" Font-Bold="True" ForeColor="Red"></asp:Label><span
                                    class="lblCaption">Case Nature :</span>
                            </td>
                            <td>
                                <asp:TextBox ID="txtNatureCase" runat="server" Width="400px" CssClass="txtDefault"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="tdTextReight">
            ...
            <act:TabPanel ID="tabList" runat="server" HeaderText="List">
                <HeaderTemplate>
                    <asp:Label ID="lblListHeaderText" runat="server" Font-Bold="True" ForeColor="#FF3300"
                        Font-Size="Small" Text="List" ToolTip="List of Nature Case Entry"></asp:Label>
                </HeaderTemplate>
                <ContentTemplate>
                    <table width="50%">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNatureCode_LIST" runat="server" Width="100px" CssClass="txtDefault"></asp:TextBox>
                                ...
                                <td style="width: 100%">
                                    <asp:GridView ID="gvMain" runat="server" AutoGenerateColumns="False" DataKeyNames="CODE"
                                        ...
                                        <Columns>
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="imgbtnView" runat="server" CausesValidation="false" CommandName="View"
                                                        ToolTip='<%# Eval("NATURECASE") %>' ImageUrl="~/images/selg_16.png" Height="20px"
                                            ...
                                            <asp:BoundField DataField="NATURECASE" HeaderText="Nature of Case" SortExpression="NATURECASE"
