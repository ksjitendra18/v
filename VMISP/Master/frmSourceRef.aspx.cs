...
{
    public partial class frmSourceRef : System.Web.UI.Page
    {
        ...
        string strSOURCEREFCODE = string.Empty;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            #region ** JS Function  **
            imgGet.Attributes.Add("onclick", "return funcSearchMaster_Validation('" + ddlTable.ClientID + "','" + txtStatusCode.ClientID + "','" + "Select Form Name...!" + "','" + "Enter Code of Source Ref...!" + "')");
            btnSubmit.Attributes.Add("onclick", "return funcSourceRefMaster_Validation('" + txtStatusCode.ClientID + "','" + ddlTable.ClientID + "','" + txtStatus.ClientID + "')");
            btnUpdate.Attributes.Add("onclick", "return funcSourceRefMaster_Validation('" + txtStatusCode.ClientID + "','" + ddlTable.ClientID + "','" + txtStatus.ClientID + "')");
            #endregion
        }
        ...
        public void funcSave(string p_strMode)
        {
            ...
            try
            {
                strSOURCEREFCODE = txtStatusCode.Text.Trim();
                strTABLE = objCommonFunction.ddlSelectedValue(ddlTable);
                strSOURCEREF = txtStatus.Text;
                ...
                cmdSave.CommandText = "[dbo].[spSourceRef_Update]";
                ...
                cmdSave.Parameters.AddWithValue("@p_SOURCEREFCODE", strSOURCEREFCODE);
        ...
        public void funcShow(string p_strNo, string strValue, string strView)
        {
            ...
            try
            {
                ...
                cmdView.CommandText = "[dbo].[spSourceRef_View]";
        ...
        public void funcBindControl(DataTable dt)
        {
            ...
            txtStatus.Text = dtData.Rows[0]["SOURCEREF"].ToString();
        ...
        protected void gvMain_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName.ToUpper() == "VIEW")
                {
                    ...
                    strSOURCEREFCODE = strValue[0];
                    strTABLE = strValue[1];

                    if (strSOURCEREFCODE != "")
                    {
                        funcShow(strSOURCEREFCODE, strTABLE, "GET");
                    }
                }
            }
            catch (Exception eg)
