<%@ Page Language="C#" AutoEventWireup="true"
    ...
    CodeBehind="frmMiscChecker.aspx.cs"
    Inherits="VMISP.Mis.frmMiscChecker" %>

<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="head">

    <title>MISC Checker</title>
    ...
    <div class="page-header">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                <h3><i id="custom-heading" style="color:white" class="bi bi-shield-check text-white"></i> MISC Checker</h3>

                <small>Review and verify MISC records assigned to you</small>
    ...
    <div class="card card-custom">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <asp:GridView ID="gvMisc"
                    runat="server"
                    CssClass="table table-hover align-middle"
                    AutoGenerateColumns="False"
                    GridLines="None"
                    EmptyDataText="No MISC records assigned to you.">
                        ...
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <a class="btn btn-primary btn-sm"
                                   href='frmMiscCheckerView.aspx?id=<%# Eval("RecordCode") %>'>
...
document.getElementById('txtSearch').addEventListener('keyup', function () {
    ...
    document.querySelectorAll("#<%=gvMisc.ClientID%> tbody tr").forEach(function (row) {
