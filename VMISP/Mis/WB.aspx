<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true"
    CodeBehind="WB.aspx.cs" Inherits="VMISP.Mis.WB" ValidateRequest="false" %>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <act:TabContainer ID="tabMain" runat="server" ActiveTabIndex="0" Width="100%" OnActiveTabChanged="tabMain_ActiveTabChanged" AutoPostBack="true">
                            <act:TabPanel ID="tabEntry" runat="server">
                                <HeaderTemplate>
                                    <asp:Label ID="lblEntryHeaderText" runat="server" Font-Bold="True" ForeColor="#FF3300" Font-Size="Small" Text="Entry" ToolTip="WB Entry"></asp:Label>
                                </HeaderTemplate>
                                <ContentTemplate>
                                    <div class="col-sm-12 alert alert-dark">
                                        <div class="form-group row" style="padding-right: 5px;">
                                            ...
                                            <div class="col-sm-1" style="padding-top: 23px;">
                                                <asp:Button ID="btnGet" runat="server" OnClick="btnGet_Click" ToolTip="WB Search" CssClass="btn btn-sm btn-info" Text="Search"></asp:Button>
                                            </div>
                                            <div class="col-sm-3">
                                                <label for="txtCompRecDate"><span style="color: #FF0000">*</span>Complaint Received Date</label>
                                                <asp:TextBox ID="txtCompRecDate" runat="server" CssClass="form-control date input-sm"></asp:TextBox>
                                            </div>
                                            <div class="col-sm-3">
                                                <label for="txtBRComplaint"><span style="color: #FF0000">*</span>Branch Complaint Received Date</label>
                                        ...
                                        <div class="form-group row" style="padding-right: 5px;">
                                            <div class="col-sm-3">
                                                <label for="txtCompNo">Complaint Number</label>
                                        ...
                                        <div class="form-group row" style="padding-right: 5px;">
                                            <div class="col-sm-3">
                                                <label for="txtCompNo">Case Number</label>
                                        ...
                                        <div class="form-group row" style="padding-right: 5px;">
                                            ...
                                            <div class="col-sm-3">
                                                <label for="txtSourceReference">Source Reference</label>
                                                <asp:TextBox ID="txtSourceReference" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                            </div>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="form-group row" style="padding-right: 5px;">
                                            ...
                                            <div class="col-sm-3">
                                                <label for="txtDateForINVReport">Date for Investigation Date</label>
                                        ...
                                        <div class="form-group row" style="padding-right: 5px;">
                                            <div class="col-sm-3">
                                                <label for="lblStatusCodeMIS">Status Code</label>
                                                <asp:DropDownList ID="ddlStatusCode" runat="server" CssClass="form-control date input-sm"></asp:DropDownList>
                            ...
                            <act:TabPanel ID="tabList" runat="server" HeaderText="WB Entry Details">
                                <HeaderTemplate>
                                    <asp:Label ID="lblListHeaderText" runat="server" Font-Bold="True" ForeColor="#FF3300"
                                        Font-Size="Small" Text="WB Entry Details" ToolTip="List of WB Entry"></asp:Label>
                                </HeaderTemplate>
                                <ContentTemplate>
                                    <div class="col-sm-12 alert alert-dark">
                                        <div class="form-group row">
