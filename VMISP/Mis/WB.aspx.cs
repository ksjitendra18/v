    ...
    public partial class WB : System.Web.UI.Page
    {
        ...
        public void funcSave(string MODE)
        {
            ...
            try
            {
                ...
                cmdSave.Parameters.AddWithValue("@p_SOURCEREF", txtSourceReference.Text.Trim());
        ...
        public void funcShow(string p_strNo, string p_strBranch, string p_strCircle, string p_strAccountName, string VIEW)
        {
            ...
            try
            {
                ...
                if (Convert.ToInt32(sqlErrCodeOutput.Value) >= 0)
                {
                    if (dt.Rows.Count > 0)
                    {
                        if (VIEW.ToUpper().Equals("LIST"))
                        {
                            gvMain.DataSource = dt;
                            gvMain.DataBind();
                        }
                        else if (VIEW.ToUpper().Equals("SEARCH"))
                        {
                            gvMain.DataSource = dt;
                            gvMain.DataBind();
                            tabMain.ActiveTabIndex = 1;
                        }
                        else if (VIEW.ToUpper().Equals("GET"))
                        {
                            funcBindControl(dt);
                        }
                        else if (VIEW.ToUpper().Equals("VIEW"))
                        {
                            funcBindControl(dt);
                        }
                    }
        ...
        public void funcBindControl(DataTable dtData)
        {
            ...
            txtSourceReference.Text = Convert.ToString(dtData.Rows[0]["SOURCEREF"]);
        ...
        protected void btnGet_Click(object sender, EventArgs e)
        {
            ...
            {
                funcShow(txtRNo.Text.Trim(), null, null, null, "GET");
            }
        }
        ...
        protected void gvMain_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (Convert.ToString(e.CommandName).ToUpper().Equals("VIEW"))
                {
                    if (!string.IsNullOrEmpty(Convert.ToString(e.CommandArgument)))
                    {
                        funcShow(Convert.ToString(e.CommandArgument), null, null, null, "VIEW");
                    }
                }
            }
            catch (Exception eg)
        ...
        protected void btnSearch_List_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(txtRNo_LIST.Text.Trim()) && string.IsNullOrEmpty(txtBranch_LIST.Text.Trim()) && string.IsNullOrEmpty(txtCircle_LIST.Text.Trim()) && string.IsNullOrEmpty(txtAccountName_LIST.Text.Trim()))
            {
                VIEW = "LIST";
            }

            funcShow(txtRNo_LIST.Text.Trim(), txtBranch_LIST.Text.Trim(), txtCircle_LIST.Text.Trim(), txtAccountName_LIST.Text.Trim(), VIEW);
        }
    }
}