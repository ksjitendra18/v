<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="SanctionForInvestigation.aspx.cs" Inherits="VMISP.Mis.SanctionForInvestigation" %>
                ...
                <div class="form-group row">
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="font-size: medium; font-weight: bold;">
                            Sanction For Investigation
                        </div>
                        <br />
                        <act:TabContainer ID="tabMain" runat="server" ActiveTabIndex="0" Width="100%">
                            <act:TabPanel ID="tabEntry" runat="server">
                                <HeaderTemplate>
                                    <asp:Label ID="lblEntryHeaderText" runat="server" Font-Bold="True" ForeColor="#FF3300" Font-Size="Small" Text="Sanction For Investigation Entry" ToolTip="Sanction For Investigation Entry"></asp:Label>
                                </HeaderTemplate>
                                <ContentTemplate>
                                    <div class="col-sm-12 alert alert-dark">
                                        <div class="form-group row" style="padding-right: 5px;">
                                            <div class="col-sm-3">
                                                <label for="txtSINO"><span style="color: #FF0000">*</span>SI Number</label>
                                                <asp:TextBox ID="txtSINumber" runat="server" CssClass="form-control input-sm" placeHolder="SI Number" onkeypress="return blockSpecialChar(event)"></asp:TextBox>
                                            </div>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="form-group row" style="padding-right: 5px;">
                                            ...
                                            <div class="col-sm-3">
                                                <label for="txtLetterToCBIDate">Letter to CBI, Sent on</label>
                                                <asp:TextBox ID="txtLetterToCBIDate" runat="server" CssClass="form-control date input-sm" placeHolder="click Here"></asp:TextBox>
                                            </div>
                                            <div class="col-sm-3">
                                                <label for="txtRCDate">Letter to CBI, Sent by</label>
                                                <asp:DropDownList ID="ddlLetterToCBISentBy" runat="server" CssClass="form-control input-sm">
                                                    <asp:ListItem Text="Select" Value="0"></asp:ListItem>
                                                    <asp:ListItem Text="DA" Value="DA"></asp:ListItem>
                                                    <asp:ListItem Text="Vigilance Deptt" Value="Vigilance Deptt"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="form-group row" style="padding-right: 5px;">
                                        ...
                                        <div class="form-group row" style="padding-right: 5px;">
                                            <div class="col-sm-12">
                                                ...
                                                <asp:TextBox ID="txtRemarks" runat="server" CssClass="form-control input-sm" placeholder="Enter Remarks, If Any...." TextMode="MultiLine"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group row" style="padding-right: 5px;">
                                            <div class="col-sm-12">
                                                <label for="txtDealingOfficerRemarks"><span style="color: #FF0000">*</span>Dealing Officer Remarks</label>
                                                <asp:TextBox ID="txtDealingOfficerRemarks" runat="server" CssClass="form-control input-sm" placeholder="Enter Dealing Officer Remarks, If Any...." TextMode="MultiLine" Enabled="false"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group row" style="padding-right: 5px;">
                                            <div class="col-sm-3">
                            ...
                            <act:TabPanel ID="tabList" runat="server" HeaderText="Sanction For Investigation Entry Details">
                                <HeaderTemplate>
                                    <asp:Label ID="lblListHeaderText" runat="server" Font-Bold="True" ForeColor="#FF3300"
                                        Font-Size="Small" Text="Sanction For Investigation Entry Details" ToolTip="Sanction For Investigation Entry Details"></asp:Label>
                                </HeaderTemplate>
                                <ContentTemplate>
                                    <div class="col-sm-12 alert alert-dark">
                                        <div class="form-group row">
                                            <div class="col-sm-2">
                                                <label for="txtSINO_LIST">SI Number</label>
                                                <asp:TextBox ID="txtSINO_LIST" runat="server" CssClass="form-control input-sm" placeholder="SI Number" onkeypress="return blockSpecialChar(event)"></asp:TextBox>
                                            </div>
                                            <div class="col-sm-2">
