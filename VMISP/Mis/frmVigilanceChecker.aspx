<%@ Page Language="C#" AutoEventWireup="true"
    ...
    CodeBehind="frmVigilanceChecker.aspx.cs"
    Inherits="VMISP.Mis.frmVigilanceChecker" %>

<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="head">

    <title>Vigilance Checker</title>
    ...
    <div class="page-header">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                <h3><i id="custom-heading" style="color:white" class="bi bi-shield-check text-white"></i> Vigilance Checker</h3>

                <small>Review and verify Vigilance records assigned to you</small>
    ...
    <div class="card card-custom">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <asp:GridView ID="gvVigilance"
                    runat="server"
                    CssClass="table table-hover align-middle"
                    AutoGenerateColumns="False"
                    GridLines="None"
                    EmptyDataText="No Vigilance records assigned to you.">

                    <Columns>

                        <asp:BoundField HeaderText="R No" DataField="RecordRef" />
                        ...
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <a class="btn btn-primary btn-sm"
                                   href='frmVigilanceCheckerView.aspx?id=<%# Eval("RecordCode") %>'>
...
document.getElementById('txtSearch').addEventListener('keyup', function () {
    ...
    document.querySelectorAll("#<%=gvVigilance.ClientID%> tbody tr").forEach(function (row) {
