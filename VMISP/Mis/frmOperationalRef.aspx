<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true"
    CodeBehind="frmOperationalRef.aspx.cs" Inherits="VMISP.Mis.frmOperationalRef" %>
                            ...
                            <act:TabPanel ID="tabEntry" runat="server">
                                <HeaderTemplate>
                                    <asp:Label ID="lblEntryHeaderText" runat="server" Font-Bold="True" ForeColor="#FF3300"
                                        Font-Size="Small" Text="Entry" ToolTip="Operational Ref Entry"></asp:Label>
                                </HeaderTemplate>
                                <ContentTemplate>
                                    <div class="col-sm-12 alert alert-dark">
                                        <div class="form-group row" style="padding-right: 5px;">
                                            <div class="col-sm-2">
                                                <label for="txtSNo"><span style="color: #FF0000">*</span>R Number</label>
                                                <asp:TextBox ID="txtRNo" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                            </div>
                                            <div class="col-sm-1" style="padding-top: 23px;">
                                                <asp:Button ID="btnGet" runat="server" OnClick="btnGet_Click" ToolTip="Operational Ref Search" CssClass="btn btn-sm btn-info" Text="Search"></asp:Button>
                                            </div>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="form-group row" style="padding-right: 5px;">
                                            <div class="col-sm-3">
                                                <label for="txtSNo"><span style="color: #FF0000">*</span>Comp Number</label>
                                            ...
                                            <div class="col-sm-3">
                                                <label for="ddlCircleOffice"><span style="color: #FF0000">*</span>Accused</label>
                                                <asp:TextBox ID="txtAccused" runat="server" CssClass="form-control input-sm">
                                                </asp:TextBox>
                                            </div>
                                            <div class="col-sm-3">
                                                <label for="txtAllegations"><span style="color: #FF0000">*</span>Allegations</label>
                                                <asp:TextBox ID="txtAllegations" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group row" style="padding-right: 5px;">
                                            <div class="col-sm-3">
                                                <label for="txtCaseNo">Case Number</label>
                                                <asp:TextBox ID="txtCaseNo" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                            </div>
                                            <div class="col-sm-3">
                                                <label for="txtIACDate"><span style="color: #FF0000">*</span>IAC Date</label>
                                        ...
                                        <div class="form-group row" style="padding-right: 5px;">
                                            ...
                                            <div class="col-sm-3">
                                                <label for="ddlSourceRef">Source Reference</label>
                                        ...
                                        <div class="form-group row" style="padding-right: 5px;">
                                            ...
                                            <div class="col-sm-3">
                                                <label for="txtSentForInvDate"><span style="color: #FF0000">*</span>Sent for Inv Date</label>
                                        ...
                                        <div class="form-group row" style="padding-right: 5px;">
                                            ...
                                            <div class="col-sm-3">
                                                <label for="txtDateForINVReport"><span style="color: #FF0000">*</span>Date for Inv Report </label>
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <asp:Panel ID="pnlNatureMIS" runat="server" Visible="false">
                                                    <label for="ddlStatusCode">MIS Nature</label>
                                        ...
                                        <div class="form-group row" style="padding-right: 5px;">
                                            <div class="col-sm-3">
                                                ...
                                                <asp:DropDownList ID="ddlStatusCode" runat="server" CssClass="form-control input-sm"></asp:DropDownList><asp:Label ID="lblStatusCodeMIS" runat="server"></asp:Label>
                                            </div>
                                            <div class="col-sm-3">
                                                <label for="txtRYSent"><span style="color: #FF0000">*</span>RY Sent</label>
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <asp:TextBox ID="txtRessonsForClosure" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                            </div>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="form-group row" style="padding-right: 5px;">
                                            ...
                                            <div class="col-sm-3">
                                                <label for="ddlLetterSentTo"><span style="color: #FF0000">*</span>Letter Sent To</label>
                            ...
                            <act:TabPanel ID="tabList" runat="server" HeaderText="List">
                                <HeaderTemplate>
                                    <asp:Label ID="lblListHeaderText" runat="server" Font-Bold="True" ForeColor="#FF3300"
                                        Font-Size="Small" Text="Operational Ref Entry Details" ToolTip="List of Operational Ref Entry"></asp:Label>
                                </HeaderTemplate>
                                <ContentTemplate>
                                    <div class="col-sm-12 alert alert-dark">
                                        <div class="form-group row">
                                            <div class="col-sm-3">
                                                <label for="txtRNo_LIST">R Number</label>
                                            ...
                                            <div class="col-sm-3">
                                                <label for="txtSourceRef_LIST">Source Reference</label>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                <label for="txtAllegations_LIST">Allegations</label>
                                                <asp:TextBox ID="txtAllegations_LIST" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                            </div>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <asp:Button ID="btnSearch_List" runat="server" OnClick="btnSearch_List_Click" ToolTip="Operational Reference Search" Text="Search" CssClass="btn btn-sm btn-info" />
                                            ...
                                            <div class="col-sm-12">
                                                <asp:GridView ID="gvMain" runat="server" OnRowCommand="gvMain_RowCommand" AutoGenerateColumns="false" CssClass="table input-sm table-bordered table-condensed">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="SENTFORINVDATE" HeaderText="Sent for Inv Date" />
                                                        <asp:BoundField DataField="REASONSFORCLOSURE" HeaderText="Ressons For Closure" />
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                                Status
                                                            </HeaderTemplate>
