...
{
    public partial class VigilanceMonitoringReports : System.Web.UI.Page
    {
        ...
        private void funcSearch()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "[dbo].[spVigilanceMonitoring_Report]";
        ...
        public void funcConvertToExcel(DataTable dt)
        {
            try
            {
                ...
                {
                    wb.Worksheets.Add(dt, "VigilanceMonitoring");
                    Response.Clear();
                    Response.Buffer = true;
                    Response.Charset = "";
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    Response.AddHeader("", "");
                    Response.AddHeader("content-disposition", "attachment;filename=VigilanceMonitoring.xlsx");
