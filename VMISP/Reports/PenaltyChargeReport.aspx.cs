...
{
    public partial class PenaltyChargeReport : System.Web.UI.Page
    {
        ...
        private void funcSearch()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "[dbo].[spPenaltyCharge_Report]";
                ...
                cmd.Parameters.AddWithValue("@p_PCNNO", txtPCNNumber.Text.Trim());
