...
{
    public partial class SanctionForProsecutionReports : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //btnGetDetails.Attributes.Add("onclick", "return funcValidation_SanctionForProsecutionReports()");
        }
        ...
        private void funcSearch()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "[dbo].[spSanctionForProsecution_Report]";
        ...
        public void funcConvertToExcel(DataTable dt)
        {
            try
            {
                ...
                {
                    wb.Worksheets.Add(dt, "SanctionForProsecution");
                    Response.Clear();
                    Response.Buffer = true;
                    Response.Charset = "";
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    Response.AddHeader("", "");
                    Response.AddHeader("content-disposition", "attachment;filename=SanctionForProsecutionDetails.xlsx");
