<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SiteMaster.Master" CodeBehind="ABBFFReport.aspx.cs" Inherits="VMISP.Reports.ABBFFReport" %>
        ...
        <div class="form-group row">
            <div class="panel panel-primary">
                ...
                <div class="col-sm-12 alert alert-dark">
                    ...
                    <br />
                    <asp:Panel ID="pnlDetails" runat="server" GroupingText="ABBFF Enquiry Details">
                        <div class="col-sm-12">
