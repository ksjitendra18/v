<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="SanctionForInvestigationReports.aspx.cs" Inherits="VMISP.Reports.SanctionForInvestigationReports" %>
        ...
        <div class="form-group row">
            <div class="panel panel-primary">
                <div class="panel-heading" style="font-size: medium; font-weight: bold;">
                    Sanction For Investigation Enquiry
                </div>
                <br />
                <div class="col-sm-12 alert alert-dark">
                    ...
                    <br />
                    <asp:Panel ID="pnlDetails" runat="server" GroupingText="Sanction For Investigation Enquiry Details">
                        <div class="col-sm-12">
                            <asp:GridView ID="gvDetails" runat="server" CssClass="table input-sm table-bordered table-condensed" AutoGenerateColumns="false">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="SI Number" HeaderText="SI Number" />
