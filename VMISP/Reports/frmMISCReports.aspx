<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true"
    CodeBehind="frmMISCReports.aspx.cs" Inherits="VMISP.Reports.frmMISCReports" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBody" runat="server">
    <asp:Panel ID="pnlMain" runat="server" Width="100%" Height="450px">
        <div style="width: 100%; border: 1px:solid; height: 20px; text-align: center; background-color: #99232F; color: White; font-weight: 700;">
            MISC Outstanding/Status Reports
        </div>
        <div id="divMain">
            <div style="border: 1px solid #000000; width: 13%; float: left; height: 400px; margin-top: 3px; text-align: left; background-color: #C0C0C0;">
                <span class="lblCaption">1) </span>
                <asp:LinkButton ID="lnkMISCOUTSTANDING" runat="server" OnClick="lnkMISCOUTSTANDING_Click"
                    CssClass="lblCaption">MISC Outstanding</asp:LinkButton><br />
                <span class="lblCaption">2) </span>
                <asp:LinkButton ID="lnkMISCSTATUS" runat="server" OnClick="lnkMISCSTATUS_Click" CssClass="lblCaption">MISC Status</asp:LinkButton><br />
                <span class="lblCaption" style="display: none;">3) </span>
                <asp:LinkButton ID="lnkMISCREPORTTOMD" runat="server" OnClick="lnkMISCREPORTTOMD_Click" CssClass="lblCaption" Visible="false">MISC Report to MD</asp:LinkButton>
            </div>
            <div style="border: 1px solid #000000; width: 86%; float: right; margin-top: 3px;">
