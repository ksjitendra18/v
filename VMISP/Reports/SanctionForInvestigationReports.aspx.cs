...
{
    public partial class SanctionForInvestigationReports : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //btnGetDetails.Attributes.Add("onclick", "return funcValidation_SanctionForInvestigationReports()");
        }
        ...
        private void funcSearch()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "[dbo].[spSanctionForInvestigation_Report]";
        ...
        public void funcConvertToExcel(DataTable dt)
        {
            try
            {
                ...
                {
                    wb.Worksheets.Add(dt, "SanctionForInvestigation");
                    Response.Clear();
                    Response.Buffer = true;
                    Response.Charset = "";
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    Response.AddHeader("", "");
                    Response.AddHeader("content-disposition", "attachment;filename=SanctionForInvestigationDetails.xlsx");
