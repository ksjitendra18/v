<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true"
    CodeBehind="frmORReports.aspx.cs" Inherits="VMISP.Reports.frmORReports" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBody" runat="server">
    <asp:Panel ID="pnlMain" runat="server" Width="100%" Height="450px">
        <div style="width: 100%; border: 1px:solid; height: 20px; text-align: center; background-color: #99232F;
            ...
            Operational Ref (OR) Outstanding/Status Reports
        </div>
        <div id="divMain">
            <div style="border: 1px solid #000000; width: 13%; float: left; height: 400px; margin-top: 3px;
                text-align: left; background-color: #C0C0C0;">
                <span class="lblCaption">1) </span><asp:LinkButton ID="lnkOROUTSTANDING" runat="server" OnClick="lnkOROUTSTANDING_Click"
                    CssClass="lblCaption">OR Outstanding</asp:LinkButton><br />
                <span class="lblCaption">2) </span><asp:LinkButton ID="lnkORSTATUS" runat="server" OnClick="lnkORSTATUS_Click" CssClass="lblCaption">OR Status</asp:LinkButton>
            </div>
