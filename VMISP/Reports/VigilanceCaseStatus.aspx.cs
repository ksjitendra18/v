...
{
    public partial class VigilanceCaseStatus : System.Web.UI.Page
    {
        ...
        private void funcSearch()
        {
            ...
            {                
                ...
                cmd.CommandText = "[dbo].[spVigilanceCaseStatus_Report]";
                ...
                cmd.Parameters.AddWithValue("@p_RNO", txtRNO.Text.Trim());
        ...
        public void funcConvertToExcel(DataTable dt)
        {
            try
            {
                ...
                {
                    wb.Worksheets.Add(dt, "VigilanceCaseStatus");
                    Response.Clear();
                    Response.Buffer = true;
                    Response.Charset = "";
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    Response.AddHeader("", "");
                    Response.AddHeader("content-disposition", "attachment;filename=VigilanceCaseStatus.xlsx");
