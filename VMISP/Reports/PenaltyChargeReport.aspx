<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="PenaltyChargeReport.aspx.cs" Inherits="VMISP.Reports.PenaltyChargeReport" %>
        ...
        <div class="form-group row">
            <div class="panel panel-primary">
                <div class="panel-heading" style="font-size: medium; font-weight: bold;">
                    Penalty not Commensurate with Charges Report
                </div>
                <br />
                <div class="col-sm-12 alert alert-dark">
                    <div class="form-group row" style="padding-right: 5px;">
                        <div class="col-sm-2">
                            <label for="txtPCNNumber">PCN Number</label>
                            <asp:TextBox ID="txtPCNNumber" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                        </div>
                        <div class="col-sm-2">
                    ...
                    <br />
                    <asp:Panel ID="pnlDetails" runat="server" GroupingText="Penalty not Commensurate with Charges Details">
                        <div class="col-sm-12">
                            <asp:GridView ID="gvDetails" runat="server" CssClass="table input-sm table-bordered table-condensed" AutoGenerateColumns="false">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="PCN No" HeaderText="PCN No" />
