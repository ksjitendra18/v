<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="VigilanceCaseStatus.aspx.cs" Inherits="VMISP.Reports.VigilanceCaseStatus" %>
        ...
        <div class="form-group row">
            <div class="panel panel-primary">
                ...
                <div class="col-sm-12 alert alert-dark">
                    ...
                    <br />
                    <asp:Panel ID="pnlDetails" runat="server" GroupingText="Vigilance Case Status Details">
                        <div class="col-sm-12">
                            <asp:GridView ID="gvDetails" runat="server" CssClass="table input-sm table-bordered table-condensed" AutoGenerateColumns="false">
                                <Columns>
                                    <asp:BoundField DataField="Case/CVC OM/CBI RC No" HeaderText="Case/CVC OM/CBI RC No" />
                                    <asp:BoundField DataField="Name/Designation/Ac Name/Branch/PF" HeaderText="Name/Designation/Ac Name/Branch/PF" />
                                    <asp:BoundField DataField="Date/Nature of charge sheet" HeaderText="Date/Nature of charge sheet" />
                                    <asp:BoundField DataField="Punishment Imposed/ Lapse Nature" HeaderText="Punishment Imposed/ Lapse Nature" />
                                    <asp:BoundField DataField="Date of order of DA" HeaderText="Date of order of DA" />
                                    <asp:BoundField DataField="Present Status" HeaderText="Present Status" />
                                    <asp:BoundField DataField="New Zone/ Circle" HeaderText="New Zone/ Circle" />
                                </Columns>
                            </asp:GridView>
