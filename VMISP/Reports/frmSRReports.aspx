<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true"
    CodeBehind="frmSRReports.aspx.cs" Inherits="VMISP.Reports.frmSRReports" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBody" runat="server">
    <asp:Panel ID="pnlMain" runat="server" Width="100%" Height="450px">
        <div style="width: 100%; border: 1px:solid; height: 20px; text-align: center; background-color: #99232F;
            ...
            SR Outstanding/Status Reports
        </div>
        <div id="divMain">
            <div style="border: 1px solid #000000; width: 12%; float: left; height: 400px; margin-top: 3px;
                text-align: left; background-color: #C0C0C0;">
                <span class="lblCaption">1) </span><asp:LinkButton ID="lnkSROUTSTANDING" runat="server" OnClick="lnkSROUTSTANDING_Click"
                    CssClass="lblCaption">SR Outstanding</asp:LinkButton><br />
                <span class="lblCaption">2) </span><asp:LinkButton ID="lnkSRSTATUS" runat="server" OnClick="lnkSRSTATUS_Click" CssClass="lblCaption">SR Status</asp:LinkButton>
                <br />
                <span class="lblCaption" style="display: none;">3) </span><asp:LinkButton ID="lnkSRREPORTTOMD" runat="server" OnClick="lnkSRREPORTTOMD_Click" CssClass="lblCaption" Visible="false">SR Report To MD</asp:LinkButton>
            </div>
