...
namespace VMISP
{
    public partial class changePwd : System.Web.UI.Page
    {
        ...
        {
            logger.Info("line 27");
            //Response.Redirect("/VigilanceMIS/Default.aspx", true);
        ...
        public static string GenerateHash(string pwd, byte[] saltAsByteArray)
        {
            ...
            try
            {
                ...
                res = Convert.ToBase64String(result);
        ...
        {
            Response.Redirect("/VigilanceMIS/Default.aspx", false);
        }
        ...
        protected void ChangePassword1_CancelButtonClick(object sender, EventArgs e)
        {
            ...
            catch (Exception ec)
            {
                Session.Abandon();
                Cache.Remove("VMISessionId" + Session["userid"].ToString());
                Response.Redirect("/VigilanceMIS/Login.aspx", true);
                VMISP.VMISP_COMM_ERROR_TRACK.VMISP_Error_Log.HandleException(ec);
            }
        }
